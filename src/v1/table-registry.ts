...
import type { MaybeSchema, SchemaTable, TableKey } from '../core/types.js';
...
/**
 * Creates a table resolver from Drizzle's v1 relational query root.
 *
...
/**
 * Reads a table object from a Drizzle v1 relational builder.
 */
